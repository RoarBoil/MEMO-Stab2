...
if not os.path.exists('features/netSurfP_before.pkl'):
    before_data = pd.read_csv('features/netSurfP_before.csv')
    for column in before_data.columns:
        if column in ['no', 'seq']:
            continue
        before_data[column] = before_data[column].apply(ast.literal_eval)
    with open('features/netSurfP_before.pkl', 'wb') as f:
        pickle.dump(before_data, f)

if not os.path.exists('features/netSurfP_after.pkl'):
    after_data = pd.read_csv('features/netSurfP_after.csv')
    for column in after_data.columns:
        if column in ['no', 'seq']:
            continue
        after_data[column] = after_data[column].apply(ast.literal_eval)
    with open('features/netSurfP_after.pkl', 'wb') as f:
        pickle.dump(after_data, f)


# Load the data
with open('features/netSurfP_before.pkl', 'rb') as f:
    before_data = pickle.load(f)

df_1 = pd.read_csv('features/single_mutation_step1.csv')
...
with open('features/netSurfP_after.pkl', 'rb') as f:
...
with open('features/netSurfP_local.pkl', 'wb') as f:
    pickle.dump(df_final, f)

with open('features/netSurfP_before.pkl', 'rb') as f:
    before_data = pickle.load(f)
with open('features/netSurfP_local.pkl', 'rb') as f:
    df_1 = pickle.load(f)
...
with open('features/all_feature_netSurfP.pkl', 'wb') as f:
    pickle.dump(df_final, f)


directory = "features/esm2/point_representations_before"
...
df.to_pickle("features/ESM_point_representations_before.pkl")

directory = "features/esm2/point_representations_after"
pickle_files = [f for f in os.listdir(directory) if f.endswith('.pkl')]
data_list = []
for file_name in tqdm(pickle_files):
    with open(os.path.join(directory, file_name), 'rb') as f:
...
df = pd.DataFrame(data_list)
df.to_pickle("features/ESM_point_representations_after.pkl")

directory = "features/esm2/sequence_representations_before"
pickle_files = [f for f in os.listdir(directory) if f.endswith('.pkl')]
data_list = []
for file_name in tqdm(pickle_files):
    with open(os.path.join(directory, file_name), 'rb') as f:
...
df = pd.DataFrame(data_list)
df.to_pickle("features/ESM_sequence_representations_before.pkl")

directory = "features/esm2/sequence_representations_after"
pickle_files = [f for f in os.listdir(directory) if f.endswith('.pkl')]
data_list = []
for file_name in tqdm(pickle_files):
...
df = pd.DataFrame(data_list)
df.to_pickle("features/ESM_sequence_representations_after.pkl")



with open('features/ESM_point_representations_before.pkl', 'rb') as f:
    before_data = pickle.load(f)
before_data['no'] = before_data['no'].apply(lambda x: int(x))
with open('features/all_feature_netSurfP.pkl', 'rb') as f:
    df_1 = pickle.load(f)
...
with open('features/ESM_point_representations_after.pkl', 'rb') as f:
    before_data = pickle.load(f)
before_data['no'] = before_data['no'].apply(lambda x: int(x))
for bat in tqdm(range(0, len(df_1), 1)):
    before_row = before_data[before_data['no'] == bat]
...
with open('features/ESM_sequence_representations_before.pkl', 'rb') as f:
    before_data = pickle.load(f)
before_data['no'] = before_data['no'].apply(lambda x: int(x))
for bat in tqdm(range(0, len(df_1), 1)):
    before_row = before_data[before_data['no'] == bat]
...
with open('features/ESM_sequence_representations_after.pkl', 'rb') as f:
    before_data = pickle.load(f)
before_data['no'] = before_data['no'].apply(lambda x: int(x))
for bat in tqdm(range(0, len(df_1), 1)):
    before_row = before_data[before_data['no'] == bat]
...
df_final.to_pickle("features/all_feature_net_esm.pkl")


directory = "features/protT5/sequence_representations_after"
pickle_files = [f for f in os.listdir(directory) if f.endswith('.pkl')]
data_list = []
for file_name in tqdm(pickle_files):
...
df = pd.DataFrame(data_list)
df.to_pickle("features/T5_sequence_representations_after.pkl")

directory = "features/protT5/sequence_representations_before"
pickle_files = [f for f in os.listdir(directory) if f.endswith('.pkl')]
data_list = []
for file_name in tqdm(pickle_files):
...
df = pd.DataFrame(data_list)
df.to_pickle("features/T5_sequence_representations_before.pkl")

directory = "features/protT5/point_representations_before"
pickle_files = [f for f in os.listdir(directory) if f.endswith('.pkl')]
data_list = []
for file_name in tqdm(pickle_files):
    with open(os.path.join(directory, file_name), 'rb') as f:
...
df = pd.DataFrame(data_list)
df.to_pickle("features/T5_point_representations_before.pkl")

directory = "features/protT5/point_representations_after"
pickle_files = [f for f in os.listdir(directory) if f.endswith('.pkl')]
data_list = []
for file_name in tqdm(pickle_files):
    with open(os.path.join(directory, file_name), 'rb') as f:
...
df = pd.DataFrame(data_list)
df.to_pickle("features/T5_point_representations_after.pkl")

with open('features/T5_point_representations_before.pkl', 'rb') as f:
    before_data = pickle.load(f)
before_data['no'] = before_data['no'].apply(lambda x: int(x))
with open('features/all_feature_net_esm.pkl', 'rb') as f:
    df_1 = pickle.load(f)
...
with open('features/T5_point_representations_after.pkl', 'rb') as f:
    before_data = pickle.load(f)
before_data['no'] = before_data['no'].apply(lambda x: int(x))
for bat in tqdm(range(0, len(df_1), 1)):
    before_row = before_data[before_data['no'] == bat]
...
with open('features/T5_sequence_representations_before.pkl', 'rb') as f:
    before_data = pickle.load(f)
before_data['no'] = before_data['no'].apply(lambda x: int(x))
for bat in tqdm(range(0, len(df_1), 1)):
    before_row = before_data[before_data['no'] == bat]
...
with open('features/T5_sequence_representations_after.pkl', 'rb') as f:
    before_data = pickle.load(f)
before_data['no'] = before_data['no'].apply(lambda x: int(x))
for bat in tqdm(range(0, len(df_1), 1)):
    before_row = before_data[before_data['no'] == bat]
...
df_final.to_pickle("features/final_preprocessed_result.pkl")
